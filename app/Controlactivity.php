...
*/
    ...
    public function getEffectivityAttribute()
    {
        ...
        $unknown = ['identifier' => 0, 'label' => 'Unknown'];
        if ($this->implementation_status == 'Not implemented') {
            $effectivity = $unknown;
        } elseif ($this->tests_expired) {
            $effectivity = $unknown;
        } elseif (!isset($lastTest)) {
            $effectivity = $unknown;
        } else {
